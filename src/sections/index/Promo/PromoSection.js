  ...
  <Promo>
      <Container>
        <Row className="justify-content-center justify-content-xl-end">
          ...
          >
            <Promo.Image>
              <img src={`${prefix}/image/index/promo-l8-img.png`} alt="man watch localistars" placeholder="blur" />
            </Promo.Image>

            <Promo.Image1>
              <img src={`${prefix}/image/index/man-350.png`} alt="man watch localistars 350" placeholder="blur" />
            </Promo.Image1>
          </Col>
