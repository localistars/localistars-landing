...
export default function ContentSectionOne(){
  ...
  <Content>
    <Content.SectionShape>
      <img src={`${prefix}/image/project-management/l2-content-1-shape.png`} alt="content" className="w-100"/>
    </Content.SectionShape>
    <Container>
      <Content.Inner>
      <Row className="align-items-center justify-content-center justify-content-lg-start">
        ...
        <Col xs="12" className="col-xl-7 col-lg-6 col-md-8 col-xs-10 order-1 order-lg-2">
          <Content.Image>
            <img src={`${prefix}/image/project-management/l2-content-img-1.png`} alt="content" className="w-100"/>
            <Content.ContentShape>
              <img src={`${prefix}/image/project-management/l2-content-img-2.png`} alt="content" className="w-100"/>
            </Content.ContentShape>
          </Content.Image>
        </Col>
      </Row>
