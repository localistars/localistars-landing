...
export default function ContentSectionTwo(){
  ...
  <Content backgrounColor="#fff">
    <Content.ContentShape>
      <img src={`${prefix}/image/project-management/l2-content-2-shape.png`} alt="content"/>
    </Content.ContentShape>
    <Container>
      <Content.Block>
      ...
      <Col className="col-xl-7 col-lg-6 col-md-8 col-xs-10">
          <Content.Image>
            <img src={`${prefix}/image/project-management/l2-content-img-2.png`} alt="content"/>
            <Content.ContentShapeTwo>
              <img src={`${prefix}/image/project-management/l2-content-2-shape-2.png`} alt="content"/>
            </Content.ContentShapeTwo>
          </Content.Image>
        </Col>
