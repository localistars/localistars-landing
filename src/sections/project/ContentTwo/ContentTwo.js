  ...
  return (
    <Content backgrounColor="#fff">
      <Content.ContentShape>
        <img
          src={`${prefix}/image/project-management/l2-content-2-shape.png`}
          alt="content"
        />
      </Content.ContentShape>
      <Container>
          ...
          <Row className="align-items-center justify-content-center justify-content-lg-start">
            <Col className="col-xl-7 col-lg-6 col-md-8 col-xs-10">
              <Content.Image>
                ...
                <Content.ContentShapeTwo>
                  <img
                    src={`${prefix}/image/project-management/l2-content-2-shape-2.png`}
                    alt="content"
                  />
                </Content.ContentShapeTwo>
              </Content.Image>
            ...
            <Col xs="12" className="col-xl-5 col-lg-6 col-md-8 col-xs-10">
              <Content.Box>
                <Content.Title as="h2">
                  {' '}
                  <SuperTag value="Connect with<br class='d-none d-lg-block'> team members<br class='d-none d-lg-block'> with ease." />{' '}
                </Content.Title>
