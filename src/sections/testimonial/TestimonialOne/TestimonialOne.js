    ...
    <Testimonial backgroundColor="#f3f4f6">
      <Container>
        <Row className="justify-content-center">
          <Col
            xs="12"
            className="col-xl-6 col-lg-8 col-md-9 col-xs-10 text-center"
          >
            {/* Section Title */}
        ...
        <Row className="justify-content-center">
          {TestimonialPosts.map(
            ({ userImage, userName, userPosition, text, id }) => {
              return (
        ...
        <Testimonial.ButtonGroups>
          <Testimonial.Button
            className="btn btn-primary btn--lg-2 text-white rounded-50 m-2"
            to="#"
          >
            More reviews
          </Testimonial.Button>
          <Testimonial.Button
            className="btn btn-outline-primary btn--lg-2 rounded-50 m-2"
            to="#"
          >
            Submit yours
          </Testimonial.Button>
