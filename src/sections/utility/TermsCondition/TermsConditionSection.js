    ...
    <Row className="justify-content-center">
      <Col className="col-xxl-8 col-xl-9 col-lg-10">
        <Terms.Content>
          ...
          <Terms.Text>Welcome to localistars (.com / .io) an internet platform ("website") owned and operated by inweso GmbH, a Switzerland corporation (“localistars”,” "we," "our", or "us"). In order to use our service including the <a href="https://localistars.app/login" target="__blank">localistars.app</a> webapplication, API (“service”), you must agree to these terms of service (“terms” or “agreement”) which govern your access to and use of our website and service. These terms contain many legal disclosures that you should read carefully.
          </Terms.Text>
          ...
          <Terms.ContentBox>
           ...
           <Terms.TitleSmall as="h5">1.0 General terms</Terms.TitleSmall>
            <Terms.List>
              <Terms.ListItem>1.1 localistars is a website providing certain services and multi-purpose translation tools.</Terms.ListItem>
              <Terms.ListItem>1.2 “Customer Content” means any data that Customer loads or enters into the service, or is otherwise accessed, stored, used, transmitted, or processed by Customer through the service, and all compilations and derivative works of such data.</Terms.ListItem>
              <Terms.ListItem>1.3 We may change the service over time as we refine and add more features or may need to stop, suspend, or modify the services, content or features. Features may be removed as we see those were not used any longer by our customers or we offer better replacement options for them. We may also remove any Customer Content from our service at our discretion with ten (10) days prior notice to Customer.</Terms.ListItem>
          ...
          <Terms.ContentBox>
            <Terms.TitleSmall as="h5">2.0 Availability of the localistars service</Terms.TitleSmall>
            <Terms.List>
              <Terms.ListItem>2.1 You understand and acknowledge that there may be interruptions in service both within and outside of our control. While we use reasonable efforts to keep the service accessible, the service may be unavailable for any reason including, without limitation, routine maintenance. Planned downtimes with expected durations longer than 30min will be announced upfront on the website.</Terms.ListItem>
              <Terms.ListItem>2.2 You understand and acknowledge that due to circumstances both within and outside of our control, access to the service may be interrupted, suspended or terminated. We retain the right at our sole discretion to deny service, or access to the service to anyone or an account, at any time and for any reason. If reasonable and possible we will inform you upfront and search for solutions not having to take that steps.</Terms.ListItem>
              <Terms.ListItem>2.3 We will not be liable for any loss or damage that you may incur as a result of some sort of unavailability in connection with the service.
              </Terms.ListItem>
            </Terms.List>
          </Terms.ContentBox>
          ...
          <Terms.ContentBox>
            ...
            <Terms.Text>You are required to register with localistars if you want to use our service. You are solely responsible for your conduct, all Customer Content, and your communications with others while using the service. You are also solely responsible for any and all activities that occur under your account.</Terms.Text>
          </Terms.ContentBox>

          <Terms.ContentBox>
            <Terms.TitleSmall as="h5">4.0 License to use and access the service</Terms.TitleSmall>
            <Terms.List>
              <Terms.ListItem>4.1 Subject to these terms and any additional terms and conditions you may agree to with us, localistars grants you a limited, revocable, non-transferable and non-exclusive license to use the service.</Terms.ListItem>
              <Terms.ListItem>4.2 These terms do not grant you any title or interest in the services, content, software or other intellectual property rights in or available through the service. Nothing in this agreement and/or in granting the License shall constitutes a waiver of our Intellectual Property under any law.</Terms.ListItem>
              <Terms.ListItem>4.3 Any new features that augment or enhance the current service, including the release of new tools and resources, shall be subject to the terms of service. Continued use of the service after any such changes shall constitute your consent to such changes.</Terms.ListItem>
              <Terms.ListItem>4.4 Any use of the service that constitutes abuse shall be determined by localistars, in its sole discretion, and we reserve the right to terminate your account if we determine you have not complied with these terms.</Terms.ListItem>
            </Terms.List>
          </Terms.ContentBox>

          <Terms.ContentBox>
            <Terms.TitleSmall as="h5">5.0 Proprietary Rights and Protection of Customer Data</Terms.TitleSmall>
            <Terms.List>
              <Terms.ListItem>
          ...
          <Terms.ContentBox>
            <Terms.TitleSmall as="h5">6.0 localistars accounts</Terms.TitleSmall>
            <Terms.Text>
            ...
            <Terms.Text>
              6.6 Identity and location verification
            </Terms.Text>
              <Terms.Text>
          ...
          <Terms.TitleSmall as="h5">7 Purpose of localistars</Terms.TitleSmall>
          ...
          <Terms.TitleSmall as="h5">8 Contractual relationship between Consumer and Creator</Terms.TitleSmall>
          ...
          <Terms.TitleSmall as="h5">9 No qualification as worker</Terms.TitleSmall>
          ...
          <Terms.TitleSmall as="h5">10 localistars fees</Terms.TitleSmall>
            ...
            <Terms.Text>
              10.1 Service fees for Creators
          ...
          <Terms.ContentBox>
            ...
            <Terms.TitleSmall as="h5">11 Non-Circumvention</Terms.TitleSmall>
            <Terms.Text>
            ...
            <Terms.Text>
             ...
             <Terms.List>
              ...
              <Terms.ListItem>
                  ...
                  <br /><br />(ii) 25% of the anticipated annualized salary or wages for one year if the Consumer offers Creator employment directly; or

                  <br /><br />(iii) all Service Fees that would be earned by localistars from the localistars Relationship during the Non-Circumvention Period, computed based on the annualized amount earned by Creator from Consumer during the most recent normalized 8-week period, or during such shorter period as data is available to localistars;

                  <br /><br />(iv) provided, however, that if the amount in (ii) and (iii) cannot be ascertained due to uncertainty or lack of sufficient information, then localistars and you agree that fee shall be USD $3,500; if only one of (ii) or (iii) can be ascertained, then localistars and you agree that amount shall be used if it is greater than USD $3,500.

                  </Terms.ListItem>

              <Terms.ListItem>
                  To pay the Opt-Out Fee, you must request instructions by sending an email message to support@localistars.com.
          ...
          <Terms.ContentBox>
            ...
            <Terms.TitleSmall as="h5">12 Third Party Providers</Terms.TitleSmall>
            <Terms.Text>
            ...
            <Terms.TitleSmall as="h5">13 Disclaimer of Warranties/Limitation of Liability</Terms.TitleSmall>
            ...
            <Terms.TitleSmall as="h5">14 GOVERNING LAW AND JURISDICTION</Terms.TitleSmall>
