...
Card.SingleBlock = styled(Box)`
    ...
    padding-bottom: 30px;
    margin: 0 55px;
    border-bottom: ${props => props.border ? props.border + " dotted rgba(37, 55, 63, 0.15)" : null};
    ${Card.Text}{
        opacity:.7;
    }
`
...
Card.CardBlock = styled(Box)`
    ...
    padding-bottom: 30px;
    margin: 0 22px;
    background:${props => props.backgroundColor ? props.backgroundColor: "#22cc74" };
    box-shadow:  ${props => props.backgroundColor ? ("0 10px 20px " + propToColor(props.backgroundColor,".40")) : ("0 10px 20px " + propToColor("#22cc74",".40"))};
`
