      ...
      <Content backgroundColor="#fff" {...rest}>
        <Container>
          <Row className="align-items-center justify-content-center">
            ...
            >
              <Content.Title as="h2">
                Get instant <br /> growth result <br /> for business.
              </Content.Title>
              <Content.Text>
                Create custom landing pages with Fastland that converts more
                visitors than any website. Easy, Reliable &amp; Fast. The best
                medicines &amp; biggest brands within 30 minutes at your home.
              </Content.Text>
            </Col>
          </Row>
        </Container>
