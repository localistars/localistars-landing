const ProcessData = [
  {
    ...
    icon: "1",
    title: "Sign up",
    text: "Complete the registration process by confirming your email address. Click on the link in the received email.",
  },
  {
    id: "sp2",
    icon: "2",
    title: "Select your profile type",
    text: "You are searching for a translator! Choose the client profile type.",
  },
  {
    id: "sp3",
    icon: "3",
