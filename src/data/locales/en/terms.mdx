...
5.6.1. These Service Terms incorporate the [localistars GDPR Data Processing Addendum (“DPA”)](/dpa), when the GDPR applies to your use of the localistars Services to process Customer Data (as defined in the DPA).
